...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = sql_optimizerConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(sql_optimizerDbContext context)
    {
        _context = context;
    }
