...
public abstract class sql_optimizerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static sql_optimizerWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(sql_optimizerWebMvcModule).Assembly.FullName);
    }
    ...
    protected async Task UsingDbContextAsync(Func<sql_optimizerDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<sql_optimizerDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<sql_optimizerDbContext, Task<T>> func)
    {
        T result;
