...
namespace sql_optimizer.Migrations
{
    ...
    [Migration("20260402092656_AddMigrationsHistory")]
    partial class AddMigrationsHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sql_optimizer.Core.Domains.Database.DatabaseConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("DumpErrorMessage")
                        .HasMaxLength(1000)
                    ...
                    b.Property<DateTime?>("LastDumpTime")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("sql_optimizer.Core.Domains.Migration.MigrationHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("MigrationSql")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("sql_optimizer.Core.Domains.QueryHistory.QueryHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("sql_optimizer.Core.Domains.SchemaAdvisor.SchemaAdvisorScan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("sql_optimizer.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("sql_optimizer.Authorization.Users.User", null)
                        .WithMany("Claims")
